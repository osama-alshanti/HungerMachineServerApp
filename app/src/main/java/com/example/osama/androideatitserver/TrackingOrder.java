...
import com.example.osama.androideatitserver.Common.DirectionJSONParser;
...
public class TrackingOrder extends FragmentActivity implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener,
    ...
    private void displayLocation() {
        ...
        else
        {
            ...
            if (mLastLocation!= null)
            {
                ...
                //after add marker for your location , now add marker for the order
                drawRoute(yourLocation,Common.currentRequest.getAddress());

            }else{
                //Toast.makeText(this, "Couldn't get the location", Toast.LENGTH_SHORT).show();

                Log.d("DEBUG","ouldn't get the location");
            }
        }
    ...
    @Override
    protected void onResume() {//est2naf
        super.onResume();
        checkPlayServices();
    }
